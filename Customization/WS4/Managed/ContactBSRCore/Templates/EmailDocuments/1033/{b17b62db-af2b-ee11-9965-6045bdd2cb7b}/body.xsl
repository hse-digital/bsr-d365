...
<div style="font-family:Arial,Helvetica,sans-serif;font-size:19px;color:#0b0c0c;background-color:transparent;margin:38px 0 19px"><h2 style="font-size:22px;margin:0;line-height:1.25"><span style="font-size:24px">Reference number</span></h2></div>
<!--[if false]> <div style="display: none"> <![endif]--> <!--[if gte mso 9]> <div style="font-family: Arial, Helvetica, sans-serif; font-size: 19px; color: #0b0c0c; background-color: transparent; margin: 0px 0px 30px;"><p style="padding: 0px; mso-line-height-rule: at-least; color: rgb(0, 0, 0); font-style: normal; font-weight: 400; letter-spacing: normal; text-align: start; text-indent: 0px; text-transform: none; text-wrap: wrap; word-spacing: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; font-family: Helvetica, Arial, sans-serif; font-size: 19px; line-height: 131.579%; margin: 0px 0px 30px;"><span class="dataslug" data-value="]]><xsl:choose><xsl:when test="incident/ticketnumber"><xsl:value-of select="incident/ticketnumber" /></xsl:when><xsl:otherwise></xsl:otherwise></xsl:choose><![CDATA[" style="color: rgb(0, 0, 0); font-style: normal; font-weight: 400; letter-spacing: normal; text-align: start; text-indent: 0px; text-transform: none; text-wrap: wrap; word-spacing: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; font-family: Helvetica, Arial, sans-serif; font-size: 19px; margin: 0px 0px 30px; background-color: #E7EFFF;">]]><![CDATA[{!Case:Case Number;}]]><![CDATA[</span></p></div> <![endif]--><!--[if false]> </div> <![endif]--> <!--[if !mso]> <!----><div style="font-family:Arial,Helvetica,sans-serif;font-size:19px;color:#0b0c0c;background-color:transparent;margin:0 0 30px"><p style="padding:0;mso-line-height-rule:at-least;color:#000;font-style:normal;font-weight:400;letter-spacing:normal;text-align:start;text-indent:0;text-transform:none;text-wrap:wrap;word-spacing:0;text-decoration-thickness:initial;text-decoration-style:initial;text-decoration-color:initial;font-family:Helvetica,Arial,sans-serif;font-size:19px;line-height:1.31579;margin:0 0 30px">]]><xsl:choose><xsl:when test="incident/ticketnumber"><xsl:value-of select="incident/ticketnumber" /></xsl:when><xsl:otherwise></xsl:otherwise></xsl:choose><![CDATA[</p></div><!--<![endif]-->
<div style="font-family:Arial,Helvetica,sans-serif;font-size:19px;color:#0b0c0c;background-color:transparent;margin:38px 0 19px"><h2 style="font-size:22px;margin:0;line-height:1.25"><span style="font-size:24px">What you told us</span></h2></div>
<!--[if false]> <div style="display: none"> <![endif]--> <!--[if gte mso 9]> <div style="font-family: Arial, Helvetica, sans-serif; font-size: 19px; color: #0b0c0c; background-color: transparent; margin: 0px 0px 30px;"><p style="padding: 0px; mso-line-height-rule: at-least; color: rgb(0, 0, 0); font-style: normal; font-weight: 400; letter-spacing: normal; text-align: start; text-indent: 0px; text-transform: none; text-wrap: wrap; word-spacing: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; font-family: Helvetica, Arial, sans-serif; font-size: 19px; line-height: 131.579%; margin: 0px 0px 30px;"><span class="dataslug" data-value="]]><xsl:choose><xsl:when test="incident/bsr_question"><xsl:value-of select="incident/bsr_question" /></xsl:when><xsl:otherwise></xsl:otherwise></xsl:choose><![CDATA[" style="color: rgb(0, 0, 0); font-style: normal; font-weight: 400; letter-spacing: normal; text-align: start; text-indent: 0px; text-transform: none; text-wrap: wrap; word-spacing: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; font-family: Helvetica, Arial, sans-serif; font-size: 19px; margin: 0px 0px 30px; background-color: #E7EFFF;">]]><![CDATA[{!Case:Question;}]]><![CDATA[</span></p></div> <![endif]--><!--[if false]> </div> <![endif]--> <!--[if !mso]> <!----><div style="font-family:Arial,Helvetica,sans-serif;font-size:19px;color:#0b0c0c;background-color:transparent;margin:0 0 30px"><p style="padding:0;mso-line-height-rule:at-least;color:#000;font-style:normal;font-weight:400;letter-spacing:normal;text-align:start;text-indent:0;text-transform:none;text-wrap:wrap;word-spacing:0;text-decoration-thickness:initial;text-decoration-style:initial;text-decoration-color:initial;font-family:Helvetica,Arial,sans-serif;font-size:19px;line-height:1.31579;margin:0 0 30px">]]><xsl:choose><xsl:when test="incident/bsr_question"><xsl:value-of select="incident/bsr_question" /></xsl:when><xsl:otherwise></xsl:otherwise></xsl:choose><![CDATA[</p></div><!--<![endif]-->
<div style="font-family:Arial,Helvetica,sans-serif;font-size:19px;color:#0b0c0c;background-color:transparent;margin:38px 0 19px"><h2 style="font-size:22px;margin:0;line-height:1.25"><span style="font-size:24px">What happens next</span></h2></div>
<div style="font-family:Arial,Helvetica,sans-serif;font-size:19px;color:#0b0c0c;background-color:transparent;margin:0 0 30px"><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least">Your question will be reviewed by BSR. Once we have reviewed it, we will contact you to tell you what we will do next. This may take up to 21 working days.&nbsp;</p><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least"><br></p><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least">If you don't hear from us after 21 working days, contact BSR, quoting your reference number.&nbsp;</p><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least"><br></p><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least">Email bsr@bsr.co.uk or phone BSR on 0300 790 6787</p><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least"><br></p><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least">BSR is open Monday to Friday from 8.30am to 5pm, except Wednesdays when we are open from 10am to 5pm.</p><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least"><br></p><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least">Thank you for bringing this matter to our attention.&nbsp;</p><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least"><br></p><p style="margin:0;padding:0;line-height:1.25;mso-line-height-rule:at-least">BSR Customer Service Team</p></div>
</th>
</tr>
</tbody>
</table>
