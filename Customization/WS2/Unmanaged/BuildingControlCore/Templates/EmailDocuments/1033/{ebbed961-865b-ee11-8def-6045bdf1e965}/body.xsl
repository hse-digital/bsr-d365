...
<div>
<div><span style="font-size:12pt"><span style="font-family:Arial,Helvetica,sans-serif"><span style="line-height:107%">Please visit the following link to submit the requested information: %%bsr_buildingcontrolwebsiteurl%%</span><br>
<br>
<br>
<span style="line-height:107%">Please note that any delay in providing this information may delay the progress of your project.</span></span></span></div>
...
Regulatory Lead</span></span></div>

<div>&nbsp;</div>

<div><span style="font-size:12pt"><span style="font-family:Arial,Helvetica,sans-serif">%%bsr_caseofficerid%%<br>
Case Officer</span></span></div>
