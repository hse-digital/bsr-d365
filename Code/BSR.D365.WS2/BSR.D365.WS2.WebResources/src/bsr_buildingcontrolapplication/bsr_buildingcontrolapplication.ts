namespace BuildingControlApplication {
    ...
    export function ShowHideStagedApplicationsTab(executionContext: Xrm.ExecutionContext<any, any>) {

        Form = <Form.bsr_buildingcontrolapplication.Main.Information>executionContext.getFormContext();
